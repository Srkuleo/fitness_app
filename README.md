...
- _Add alert before deleting, confirming changing w/o. Also add alert message before closing add or change form. Refactor both forms and add animation with framer motion to carousel, forms and modals._
