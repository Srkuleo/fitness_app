...
export const NavBar = ({ children }: Partial<WrapperProp>) => {
  return (
    <div className="mx-auto flex justify-between bg-gradient-to-r from-orange-button600 via-green-main500 to-green-dark600 px-4 py-2 dark:from-orange-dark700 dark:to-green-dark700 md:w-4/6 md:border-b-2 md:border-slate-light400 md:from-tp md:px-0 md:dark:from-tp lg:w-3/6">
      <NoteSet />
