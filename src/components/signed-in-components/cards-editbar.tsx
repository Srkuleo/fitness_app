  ...
  return (
    ...
    Leaving: "ease-in duration-200"
      ...
      To: "opacity-0" */}
          ...
          <div className="fixed inset-0 bg-slate-dark900 bg-opacity-80 transition-opacity"></div>
        ...
        Leaving: "ease-in duration-200"
          ...
          To: "opacity-0 translate-y-4 sm:translate-y-0 sm:scale-95" */}
              ...
              <div className="relative transform overflow-hidden rounded-lg bg-slate-light50 text-left shadow-xl transition-all sm:my-8 sm:w-full sm:max-w-lg">
                <div className="bg-slate-light50 px-4 pb-4 pt-5 sm:p-6 sm:pb-4">
                  <div className="sm:flex sm:items-start">
                    ...
                    <div className="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left">
                      <h3
                        className="text-base font-semibold leading-6 text-slate-dark900"
                        id="modal-title"
                      >
                        Remove {`"${currWorkout.name}"`} workout
                      </h3>
                      <div className="mt-2">
                        <p className="text-sm text-slate-main600">
                          Are you sure you want to remove this workout? Selected
                          workout will be permanently removed. This action
                          cannot be undone.
                        </p>
                      </div>
                    </div>
                ...
                <div className="bg-slate-light200 px-4 py-3 sm:flex sm:flex-row-reverse sm:px-6">
                  <button
                    onClick={() => {
