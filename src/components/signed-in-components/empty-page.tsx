...
export const EmptyPage = () => {
  return (
    <div className="flex h-full min-w-full flex-col items-center justify-center gap-4 xs:my-auto xs:min-h-[540px] xs:min-w-[370px] xs:flex-grow-0 xs:rounded-2xl xs:border-2 xs:border-dashed xs:border-orange-dark700 xs:bg-white xs:dark:border-orange-button600 xs:dark:bg-slate-dark800">
      {DbIcon}
